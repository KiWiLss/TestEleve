 ...
 * -----------------------------------------------------------------
 *
 * @File: WechatActivity.java
 * @Author: winding.kiwi.lss
 * @Version: V100R001C01
 * @Create: 2017/11/30 17:08
 * @Changes (from 2017/11/30)
 * -----------------------------------------------------------------
 * 2017/11/30 : Create WechatActivity.java (winding);
 * -----------------------------------------------------------------
 * @description ${DESCRIPTION}
 */

public class WechatActivity extends AppCompatActivity implements SensorEventListener{
    ...
    private class MyHandler extends Handler {
        private WeakReference<WechatActivity> mReference;
        private WechatActivity mActivity;


        public MyHandler(WechatActivity activity) {
            mReference = new WeakReference<WechatActivity>(activity);
            if (mReference != null) {
